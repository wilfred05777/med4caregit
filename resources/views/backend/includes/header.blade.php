<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{ asset('img/backend/brand/logo-med4care.png') }}" width="89" height="25" alt="Med4Care Logo">
        <img class="navbar-brand-minimized" src="{{ asset('img/backend/brand/logo-med4care.png') }}" width="30" height="30" alt="Med4Care Logo">
    </a>
